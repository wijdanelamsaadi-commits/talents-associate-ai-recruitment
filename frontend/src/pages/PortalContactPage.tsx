...
const contactCards: ContactCard[] = [
  {
    ...
    icon: PhoneIcon,
    iconWrapClass: "bg-[#EE6C2F]/10",
    iconColorClass: "text-[#EE6C2F]",
  },
  {
    title: "WhatsApp",
    value: "+212 (0) 6 88 12 88 13",
    ...
    <main className="bg-white">
      ...
      <section className="mx-auto max-w-3xl px-6 py-10 lg:py-12">
        <div className="grid gap-5">
          {contactCards.map((card) => (
            <a
              className="group flex cursor-pointer items-center gap-5 rounded-[20px] border border-slate-100 bg-white px-6 py-5 shadow-lg shadow-slate-900/5 transition duration-300 hover:-translate-y-1 hover:border-[#EE6C2F] hover:shadow-xl hover:shadow-orange-500/10 sm:gap-6 sm:px-8 sm:py-6"
              href={card.href}
              key={card.title}
            ...
            >
              ...
              <span className="min-w-0">
                <span className="block text-base font-extrabold text-[#24303F]">{card.title}</span>
      ...
      <section className="mx-auto max-w-3xl px-6 pb-20">
        <div className="flex flex-col items-center gap-4 rounded-[20px] bg-[#FFF7F2] px-8 py-10 text-center">
          <span className="flex h-16 w-16 items-center justify-center rounded-full bg-[#EE6C2F]/10 text-[#EE6C2F]">
            {ClockIcon}
          </span>
          <h2 className="text-xl font-extrabold text-[#24303F]">Disponibles pour vous</h2>
          ...
          <Link
            className="mt-1 text-sm font-bold text-[#EE6C2F] transition hover:text-[#D9551B]"
            to="/portal/jobs"
          >
