  ...
  return (
    <main className="mx-auto grid max-w-5xl gap-6 px-4 py-8 sm:px-6 lg:grid-cols-[0.85fr_1.15fr]">
      <aside className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        <p className="text-sm font-semibold uppercase text-[#EE6C2F]">Espace candidat</p>
        <h1 className="mt-2 text-3xl font-semibold text-[#24303F]">Créez votre profil Talents Associate</h1>
        ...
        <p className="mt-5 text-sm text-slate-600">
          Déjà inscrit ?{" "}
          <Link className="font-semibold text-[#EE6C2F] hover:text-[#D9551B]" to="/portal/login">
            Se connecter
          </Link>
        </p>
      </aside>
      ...
      <section className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        <form className="grid gap-4 sm:grid-cols-2" onSubmit={handleSubmit}>
          ...
          <button
            className="rounded-lg bg-[#EE6C2F] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#D9551B] disabled:bg-slate-400 sm:col-span-2"
